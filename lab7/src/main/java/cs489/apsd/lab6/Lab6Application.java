...
public class Lab6Application implements CommandLineRunner {
    ...
    public Lab6Application(AddressRepository addressRepository, PatientRepository patientRepository, DentistRepository dentistRepository, SurgeryRepository surgeryRepository, AppointmentRepository appointmentRepository) {
